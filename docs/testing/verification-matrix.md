...
| Z-order/lock | ZORDER/LOCK | Debug/Release pass; 0 warnings/0 errors | Debug/Release 232 passed, 0 failed; TASK-080専用20/20 | WPF pointer/DPI/IME/final-pixel/context-menu OS behavior Not verified | Text/balloon/attached-symbol selection uses common 4-operation toolbar and locked selection remains unlockable; mid-gesture production lock cancels before capture; parent-window controls refresh immediately | Linked and unlinked typed blocks retain canonical internal order; lock and Z-order state round-trips through format 2.3 Japanese path | Japanese toolbar/context menu and safe refusal messages | 2.0〜2.2 read compatibility via existing suite; 2.3 write; canonical ZIndex; old-link/member lock atomic refusal; context handler detach; distinguishable TryAdd refusal | TASK-080 / implementation commits `0bb2be75ece679e669e399e853401035d8896bae`, `631620b61cc2834e8b5dfa0ef7d34f08920adf39` | C080-01〜12: 3 types×4 Z actions×toolbar/context, model/live/Canvas/selection, saved dirty/Undo/Redo/redo branch/subscriber, non-vacuous removal/rebind/unbind/Dispose lifecycle; performance Debug/Release p95 1.186/1.435 ms, batch 103.356/116.178 ms |
