...
| Grapheme handling | UNICODE | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 136 passed, 0 failed | UI/render Not verified | variation/modifier/RI/ZWJ/CRLF/empty fixtures | Japanese/emoji text round-trip | N/A: model lane | Grapheme service exposes UTF-16 ranges and lossless reconstruction | TASK-090 | UI integration remains TASK-100 |
| Attached symbols | SYMBOL | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 136 passed, 0 failed | UI/render/drag Not verified | parent/anchor/offset/inheritance round-trip | SetMojiDatas、policy、ID atomicity、Undo/Redo、2.1 read compatibility | Required by TASK-100 | page format 2.2, 2.0/2.1 reader compatibility, future 2.3 rejection | TASK-090 | UI/renderer remains TASK-100 |
| Basic balloon model | BALLOON | Debug/Release pass (0 warnings, 0 errors) | Debug 116 passed, 0 failed | UI/render/handles Not verified | Tategaki text relationship round-trip | Yokogaki/Unicode text relationship round-trip | N/A: model-only task | page.xml version 2.2, version 2.0/2.1 read compatibility, future version rejection, unknown shape fallback, invalid numeric validation | TASK-110/TASK-090 | UI/rendering remains TASK-120 |
