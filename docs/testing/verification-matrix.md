...
| Non-destructive balloon merge | BALLOON-MERGE/ZORDER/LOCK/UNDO | Debug/Release pass、警告0・エラー0 | Debug/Release 246/246、TASK-150専用8/8 | 実WPF pointer/DPI/IME/final-pixel目視はNot verified | linked Tategaki text、layout state、付加記号を保持してgroup移動・取消・Undo/Redoを確認 | linked Yokogaki text、unlinked balloon、tailを同一deltaで移動し、member dataをmerge/unmerge前後でdeep比較 | 実XAMLの候補ComboBox、「フキダシ合体」「合体解除」、日本語status／拒否理由、handle無効化を確認 | version 2.4 ordered merge round-trip、2.0〜2.3 mergeなし、2.5拒否、invalid 2.4 atomic拒否、日本語project/page/path | TASK-150 / `0f9a657c89159f94f42a61f04e87d507cf040afc` | 5 shape、rotation、overlap/touch/containment/non-overlap、tail、内部stroke抑制、transparent gap exact hit、bounded cache、one visual、lifecycleを確認。Debug p95 0.049 ms／100 batch 85.828 ms、Release p95 0.045 ms／100 batch 112.663 ms |
...
- Debug/Release 246/246合格、警告0・エラー0です。実WPF pointer/DPI/IME/final-pixel目視はNot verifiedです。
