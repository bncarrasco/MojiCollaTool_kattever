...
| Basic balloon model | BALLOON | Debug/Release pass (0 warnings, 0 errors) | Debug 116 passed, 0 failed | UI/render/handles Not verified | Tategaki text relationship round-trip | Yokogaki/Unicode text relationship round-trip | N/A: model-only task | page.xml version 2.1, version 2.0 read compatibility, future version rejection, unknown shape fallback, invalid numeric validation | TASK-110 | UI/rendering remains TASK-120 |
