...
| Z-order/lock | ZORDER/LOCK | Debug/Release pass; 0 warnings/0 errors | Debug/Release 224 passed, 0 failed; TASK-080専用12/12 | WPF pointer/DPI/IME/final-pixel/context-menu OS behavior Not verified | Text/balloon/attached-symbol selection uses common 4-operation toolbar and locked selection remains unlockable; C080 gesture/property/semantic guards | Linked and unlinked typed blocks retain canonical internal order; lock and Z-order state round-trips through format 2.3 | Japanese toolbar/context menu and safe refusal messages | 2.0〜2.2 read compatibility, 2.3 write, canonical ZIndex normalization, locked member atomic refusal, operation-specific edge availability | TASK-080 / implementation commit `b6cc90bae3f05d2a9342003221f95775bb7a6641` | C080-01〜05: production gesture atomicity, MojiWindow lock controls, semantic command guards, shared toolbar/context availability, lifecycle/Dispose tests; performance budget included (Debug/Release p95 2.006/1.305 ms, 100 operations 169.153/103.476 ms) |
