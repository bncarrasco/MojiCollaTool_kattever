...
| Attached symbols | SYMBOL | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 137 passed, 0 failed | UI/render/drag Not verified | parent/anchor/offset/inheritance round-trip | SetMojiDatas、policy、ID atomicity、Undo/Redo、2.1 read compatibility | Required by TASK-100 | page format 2.2, 2.0/2.1 reader compatibility, future 2.3 rejection | TASK-090 | UI/renderer remains TASK-100 |
