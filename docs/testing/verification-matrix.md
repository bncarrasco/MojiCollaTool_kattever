...
| Fork identity | FORK | Not verified（SDK 6.0.428 unavailable） | Not run | MainWindow title、ヘルプ→このアプリについて、Aboutの非公式フォーク・原作者非関係・問い合わせ注意、Assembly/package metadataを静的確認 | Not verified | Not verified | LICENSE/THIRD-PARTY-NOTICES.md案内をAboutに維持 | Root MIT retained; WpfColorPicker Apache-2.0 notice retained。installer/ZIPはscope外 | TASK-190B | build/test/manual app launchはSDK不足のため未検証 |
