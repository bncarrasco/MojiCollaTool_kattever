...
| Attached symbols | SYMBOL | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 157 passed, 0 failed | WPF manual pointer/DPI inspection Not verified | parent/anchor/offset/inheritance round-trip | SetMojiDatas、policy、ID atomicity、Undo/Redo、2.1 read compatibility、UI capture/reanchor/selection | Required by TASK-100 | page format 2.2, 2.0/2.1 reader compatibility, future 2.3 rejection | TASK-090/TASK-100 | Grapheme renderer、追加・削除・property update、drag history、font fallbackを自動検証 |
