...
| Basic balloon model/rendering | BALLOON | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 184 passed, 0 failed | Manual WPF pointer/DPI/final-pixel inspection Not verified | Tategaki link preserves direction/font/content | Yokogaki/Unicode link preserves direction/font/content | Japanese shape/tail/link/Z-order controls and safe error state | page.xml version 2.2, version 2.0/2.1 read compatibility, future version rejection, geometry fallback/cache | TASK-110/TASK-120/TASK-130 | body/tail geometry hit、3 tail handle、composition move/Z、historyを実装 |
| Tail/text typed composition | BALLOON/ZORDER/UNDO | Debug/Release pass (0 warnings, 0 errors) | TASK-130 9 passed; suite 184 passed, 0 failed | Manual WPF pointer/DPI/final-pixel inspection Not verified | Tategaki text remains unchanged on link/move | Yokogaki text remains unchanged on link/move | 「しっぽ追加/削除」「文字をリンク/リンク解除」「最前面へ/前面へ/背面へ/最背面へ」と日本語拒否表示 | single-tail、同一page一対一link、text削除unlink、balloon削除text保持、typed block保存再読込、2.0/2.1互換 | TASK-130 / `e2137363ddbccfd34b636628a72d792a99590f73` | Release: tail refresh/hit 2,400回 421.482 ms、root drag 40回 0.212 ms、各閾値3,000 ms |
