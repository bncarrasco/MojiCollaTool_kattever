...
| Attached symbols | SYMBOL | Debug/Release pass (0 warnings, 0 errors) | Debug/Release 165 passed, 0 failed | WPF manual pointer/DPI/IME/final-pixel inspection Not verified | parent/anchor/offset/inheritance/decoration/spacing/detached round-trip | SetMojiDatas、orphan policy、cross-object ID atomicity、Undo/Redo、2.1 read compatibility、UI capture/reanchor/selection、detached save/reload、hidden rendering、grapheme refresh baseline | Required by TASK-100 | page format 2.2, 2.0/2.1 reader compatibility, future 2.3 rejection | TASK-090/TASK-100 | TASK100AttachedSymbolUiTests 10 tests: grapheme edge cases, all candidates/arbitrary text, placement/parent transform, font fallback/name, decoration/spacing, drag/capture loss, page/project/selection/Dispose, detached preservation, IsVisible=false, mixed Z-order, refresh performance |
