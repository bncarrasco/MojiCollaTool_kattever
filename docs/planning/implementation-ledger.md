...
| TASK-040 | Complete | `feature/TASK-040-versioned-project-format` | `F:/github/MojiCollaTool-worktrees/TASK-040` | `18f01d1` | `HEAD` | SAVE,PAGE,OBJECT | ADR-0005 | Debug/Release pass, 0 warnings, 0 errors | 38 passed | Page-scoped image source/sink, 0/1/2 image round-trip, Japanese path, stale asset absence, version/order/name/DTD/traversal/fault validation | Pending integration review | None | TASK-041 |
