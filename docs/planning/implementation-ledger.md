...
| TASK-041 | Complete | `feature/TASK-041-legacy-project-import` | `F:/github/MojiCollaTool-worktrees/TASK-041` | `6cc9b43` | `RESULT-COMMIT-SEE-WORKER-REPORT` | COMPAT | ADR-0005 | Debug/Release pass, 0 warnings, 0 errors | 49 passed | Legacy detector/reader/mapper, one-page deep-copy import, Japanese migration warning, image batch restoration, extension-independent detection, DTD rejection | Pending integration review | None | TASK-030 |
