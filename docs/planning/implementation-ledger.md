...
| TASK-060 | Complete (local) | `feature/TASK-060-object-id-zindex` | `F:/github/MojiCollaTool-worktrees/TASK-060` | `1e64a715adeb2102f15b6a932075f5afdb65ff44` | implementation commit（report参照） | OBJECT,ZORDER | ADR-0003 | Not verified: .NET SDK 6.0.428 missing | Not verified: test project could not start | UI変更なし。UUID/Type/ZIndex/lock/visibility/relationship fields、page/project duplicate checks、canonical Z snapshot、round-trip testsを追加 | Pending integration review | SDK 6.0.428未導入、専用TASK-060.md未配置 | TASK-070/080 |
