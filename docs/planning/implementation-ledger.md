...
| TASK-030 | Complete | `feature/TASK-030-project-page-tabs` | `F:/github/MojiCollaTool-worktrees/TASK-030` | `8875af4696663f34a6ba72f255b2f9e209578dd2` | `124e3e4ff0883dcffeaecc6d28cf724abc291b39` | REQ-PAGE-001, REQ-WORKSPACE-001, REQ-DIRTY-001, REQ-UI-JA-001 | ADR-0001/2 | Debug/Release pass, 0 warnings, 0 errors | 63 passed | 二段project/page tab、複数session/page状態、versioned/legacy transaction、session/page asset隔離、UI/manualはNot verified | Review/merge pending | なし | TASK-050/TASK-170 |
