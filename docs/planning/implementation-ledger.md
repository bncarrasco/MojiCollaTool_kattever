...
| TASK-025 | Complete | feature/TASK-025-workspace-project-session | `F:/github/MojiCollaTool-worktrees/TASK-025` | `a46c29a`（TASK-010 HEAD） | final amended T025 commit（git log参照） | WORKSPACE,DIRTY | ADR-0001 | Debug/Release pass (0 warnings, 0 errors), SDK 6.0.428 | 24 passed; WorkspaceTests 8件 | UI/serializer変更なし。複数session隔離、active page、path重複拒否、dirty close、単調増加revision tokenを確認 | Pending integration review | なし | TASK-030 |
