...
| TASK-030 | Complete | `feature/TASK-030-project-page-tabs` | `F:/github/MojiCollaTool-worktrees/TASK-030` | `8875af4696663f34a6ba72f255b2f9e209578dd2` | `レビュー修正commitで確定` | REQ-PAGE-001, REQ-WORKSPACE-001, REQ-DIRTY-001, REQ-UI-JA-001 | ADR-0001/2 | Debug/Release pass, 0 warnings, 0 errors | 71 passed | capture/変更通知分離、STA tab選択復元、画像transaction失敗保護、二段tab、session/page asset隔離、UI/manualはNot verified | Review/merge pending | なし | TASK-050/TASK-170 |
