...
| TASK-030 | Ready | `feature/TASK-030-project-page-tabs` | `F:/github/MojiCollaTool-worktrees/TASK-030` | `8875af4`（T041統合HEAD） | - | PAGE,WORKSPACE,DIRTY,UI | ADR-0001/2 | Not run | Not run | Not verified | Worker prompt作成済み、正式worktree登録後に開始 | なし | 実装開始 |
