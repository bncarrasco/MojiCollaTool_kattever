...
| TASK-050 | Kickoff ready | `feature/TASK-050-batch-page-export` | `F:/github/MojiCollaTool-worktrees/TASK-050`（司令役が本wave開始commitから作成） | 本wave開始commit | - | REQ-EXPORT-001, REQ-UI-JA-001 | - | Not run | Not run | Not verified | TASK-110とのfile ownershipを固定して並行開始 | TASK-200とMainWindow/PageEditor競合 | TASK-110と並行 |
