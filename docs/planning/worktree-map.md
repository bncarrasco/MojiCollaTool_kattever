...
| TASK-190B | `feature/TASK-190B-app-branding` | `F:/github/MojiCollaTool-worktrees/TASK-190B` | `1e64a715adeb2102f15b6a932075f5afdb65ff44` | TASK-020、TASK-190A | `docs/worker-prompts/TASK-190B.md` | In progress |
...
次taskのworktreeはまだ作成しない。`parallelization-plan.md`で選定後、worker promptをcommitしたexact HEADから司令役が登録する。
